<div class="app-form app-form-contact inactive-form">
    ...
    <form id="form-contact" action="/application/contact-info-submit/{{ $application_id  }}">
        <div class="row mt-2">
            <div class="col-xs-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                <div class="row ">
                    ...
                    <div class="col-xs-12 col-md-4 mt-4">
                        <div class="form-group">
                            <label for="contact-tel">تلفن ثابت <span class="sub-label">بدون کد شهر</span> <i class="fa fa-star text-required"></i></label>
