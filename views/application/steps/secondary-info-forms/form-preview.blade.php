<div class="app-form app-form-preview inactive-form">
                    ...
                    <div class="col-6">  
                        <div class="form-group">
                            <label for="preview-image-front">تصویر رو پروانه</label>                                       
                             <img id="preview-image-front1" class="w-100" src="تصویر رو پروانه" alt="">
                        </div>                  
                    </div>                      
                    <div class="col-6">  
                        <div class="form-group">
                            <label for="preview-image-rear">تصویر پشت پروانه</label>                                       
                            <img id="preview-image-rear1" class="w-100" src="تصویر پشت پروانه" alt="">
                        </div>                  
                    </div>
                </div>
            </div>
    ...
    <form id="form-preview" action="/application/preview-submit">
