                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6 mt-4">
                        <div class="form-group">
                            <img id="preview-image-front" class="w-100" src="" style="display: none;" alt="">
                        </div>
                        <input type="hidden" id="front-prev">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-md-6 mt-4">
                        <div class="form-group">
                            <img id="preview-image-rear" class="w-100" src="" style="display: none;" alt="">
                        </div>
                        <input type="hidden" id="rear-prev">
                        <div class="form-group">
