...
<div style="width: 100%;">
    <table style="border-collapse: collapse;width: 100%;">
        ...
        <tr>
            ...
            <th style="border:1px solid #DDD;text-align: center;padding: 8px;background-color: #DDD;">نوع پروانه</th>
            <th style="border:1px solid #DDD;text-align: center;padding: 8px;background-color: #DDD;">استان</th>
            <th style="border:1px solid #DDD;text-align: center;padding: 8px;background-color: #DDD;">نوع شخص</th>
        ...
        <tbody>
           @foreach($items as $index => $item)
               <tr>
                   ...
                   <td style="border:1px solid #DDD;text-align: center;padding: 8px;">{{ $item->license_type_title }}</td>
                   <td style="border:1px solid #DDD;text-align: center;padding: 8px;">{{ $item->province_title }}</td>
                   <td style="border:1px solid #DDD;text-align: center;padding: 8px;">{{ $item->person_type_title }}</td>
