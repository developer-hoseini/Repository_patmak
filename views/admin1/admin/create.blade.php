...
@section('css-add')
    <style type="text/css">
        .nav-tabs .nav-item.show .nav-link, .nav-tabs .nav-link.active {
            border: 0;
            background-color: #0992AD !important;
            border-top: 3px solid #0992AD !important;
        }
    </style>
@endsection
                ...
                <div class="col-sm-5">
                    <div class="row">
                        <div class="col-sm-12 d-flex align-items-center justify-content-between">
                            <h4 class="fw-bold">افزودن کاربر جدید</h4>
                        </div>
                        <div class="col-sm-12">
                            <form action="{{ route('admin.admin.store') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 my-3 d-flex align-items-end justify-content-center">
                                        ...
                                        <button class="btn btn-success btn-lg  mx-3" type="submit">ایجاد کاربر
                                        </button>
                                    </div>
                                </div>
                            </form>
