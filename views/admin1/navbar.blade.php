    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mymenu">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" target="_self" href="/admin/application"><i class='fa fa-clipboard-list'></i>لیست پرداخت ها</a>
                </li>
                @if(\App\Facades\AuthAdminFacade::getAdminTypeId() == 1)
                    <li class="nav-item">
                        <a class="nav-link" target="_self" href="/admin/admin"><i class='fa fa-clipboard-list'></i> لیست کاربران</a>
                    </li>
                @endif
                @if(\App\Facades\AuthAdminFacade::getAdminTypeId() == 1)
                    <li class="nav-item">
                        <a class="nav-link" target="_self" href="/admin/request"><i class='fa fa-clipboard-list'></i> لیست درخواست ها</a>
                    </li>
                @endif
                @if(\App\Facades\AuthAdminFacade::getAdminTypeId() == 1)
                    <li class="nav-item">
                        <a class="nav-link" target="_self" href="/admin/report_download"><i class='fa fa-clipboard-list'></i> گزارشگیری</a>
                    </li>
                @endif
                @if(\App\Facades\AuthAdminFacade::getAdminTypeId() == 1)
                <li class="nav-item">
