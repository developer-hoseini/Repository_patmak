                            ...
                            <div class="row">
                                <div class="col-2 py-2">
                                    <div class="form-group">
                                        <select name="" id="province_title" class="form-control form-control-lg border-success" style="height: 70px !important;border-radius: 10px;"
                                ...
                                <div class="col-2 py-2">
                                    <div class="form-group">
                                        <select name="" id="admin_type_id" class="form-control form-control-lg border-success" style="height: 70px !important;border-radius: 10px;"
                                ...
                                <div class="col-2 py-2">
                                    <div class="form-group">
                                        <select name="" id="is_active" class="form-control form-control-lg border-success" style="height: 70px !important;border-radius: 10px;"
                                        ...
                                        <div class="card-body p-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <input type="text" class="form-control" onchange="changeCondition(this,'start_date')">
                                                    </div>
                                                    <div class="col-4">
                                                        <input type="text" class="form-control" onchange="changeCondition(this,'end_date')">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div>
                                ...
                                <a href="{{ route('admin.admin.create') }}" class="btn btn-success mx-1" style="background-color: #81be00;">
                                    <img src="{{ asset('assets/img/user-add-icon.png') }}" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-12">
