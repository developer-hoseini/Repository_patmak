                ...
                <div class="col-xs-12 col-md-6 offset-md-6 col-lg-6 offset-lg-6 col-xl-3 offset-xl-9  login-div">
                    ...
                    <div class="row mt-3">
                        <div class="col-xs-12 col-lg-10 offset-lg-1">
                            <a href="/authenticate" target="_blank"><button class="btn btn-light w-100 text-start py-2"><i class="fa fa-external-link-alt text-primary"></i> <span>ورود به سامانه</span></button></a>
                        </div>
                    </div>
                    {{-- <div class="row mt-3">
                        <div class="col-xs-12 col-lg-10 offset-lg-1">
